  ...
  return (
    <div className="group flex items-center gap-4 bg-[#0d1a0f] border border-emerald-900/30 hover:border-emerald-800/50 rounded-xl px-4 py-3.5 transition-all duration-300">
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <button
          onClick={() => onDelete(id)}
          className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-700 hover:text-red-400 hover:bg-red-500/10 opacity-0 group-hover:opacity-100 transition-all duration-200"
